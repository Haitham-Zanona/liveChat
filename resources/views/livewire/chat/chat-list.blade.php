                    ...
                    <a href="#"
                        ...
                        <div class="flex gap-x-2 items-center">
                            ...
                            <p class="grow truncate text-sm font-[100]">
                                Lorem ipsum dolor sit amet consectetur, adipisicing elit. Iure incidunt consequatur
                                ullam enim earum. Numquam aperiam suscipit officiis quaerat nulla similique nemo
                                praesentium, dolorum placeat quae id fugiat tempore eaque.
                            </p>
                        ...
                        <x-dropdown align="right" width="48">
                            ...
                            <x-slot name="content">
                                ...
                                <div class="w-full p-1">
                                    <button class="items-center gap-3 flex w-full px-4 py-2 text-left text-sm leading-5 hover:bg-gray-100 transition-all duration-150 ease-in-out focus:outline-none focus:bg-gray-100">
                                        <span>
